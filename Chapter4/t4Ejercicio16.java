...
public class t4Ejercicio16 {
  public static void main(String[] args) {
   ...
   System.out.print("Cuestionario de infidelidad  ");
   System.out.print("Responde a las preguntas con YES/NO  ");
   ...
   if (respuesta.equals("YES")) {
    ...
    System.out.print("4. Ahora se afeita y se asea con más frecuencia (si es hombre) ");
  ...
  if ((puntos < 30) && (puntos >20)) {
      System.out.println("Tu pareja tiene todos los ingredientes para estar viviendo un romance con otra persona. Te aconsejamos que indagues un poco más y averigües que es lo que está pasando");
   }
   
   if (puntos == 30) {
      System.out.println("Pues un poco zorra si que es");
